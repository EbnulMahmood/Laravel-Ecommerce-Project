...
@section('content')
@section('title')
    {{ (session()->get('language') == 'bangla') ? 'অর্ডারস' : 'Canceled Orders' }}
@endsection
@php
    $user = Auth::user();
@endphp
  ...
  <div class="pb-2 py-lg-3">
      <div class="container text-light">
          <div class="row align-items-center">
              <div class="col-lg-8">
                  <h2 class="mb-0 h4">Canceled Orders</h2>
              ...
              <div class="col-lg-4 text-lg-right pt-2 pt-lg-0">
                  <ol class="breadcrumb breadcrumb-light justify-content-lg-end">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Canceled Orders</li>
                  </ol>
              </div>
          </div>
      </div>
                                            ...
                                            <div class="col-xl-2 text-center pt-3 pt-xl-0">
                                                @if ($order->status === 'Delivered')
                                                    @if ($order->return_reason !== null)
                                                        <small class="p-1 bg-light-warning rounded-sm text-white btn-block text-uppercase">
                                                            Cancel Requested
                                                        </small>
                                                    @else
                                        ...
                                        <div class="text-left p-3">
                                            <div class="dropdown d-inline">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton-1">
                                                    ...
                                                    @if ($order->status !== 'Canceled' && $order->return_reason === null)
