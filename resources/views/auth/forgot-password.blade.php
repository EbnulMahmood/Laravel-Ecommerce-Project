...
@section('content')
@section('title')
    {{ (session()->get('language') == 'bangla') ? 'পাসওয়ার্ড ভুলে গেছেন' : 'Forgot Password' }}
@endsection
  <!-- Breadcrumbs -->
    ...
    <div class="pb-2 py-lg-3">
        <div class="container text-light">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h2 class="mb-0 h4">Forgot Password</h2>
                    <small class="pre-label d-none d-lg-block">Forgot your Password?</small>
                </div>
                ...
                <div class="accordion" id="accordion1">
                    ...
                    <div class="card bg-white shadow-sm mb-2">
                        ...
                        <div class="card-header py-4 bg-white">
                            <h2 class="h4 mb-0">Trouble Logging In?</h2>
                        </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-4 p-md-6">
                                <div class="row justify-content-center py-4">
                                    <div class="col-md-8">
                                        <p>Enter your email address we'll send you a link to get back into your account.</p>
                                        @if (session('status'))
